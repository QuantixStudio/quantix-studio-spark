...
export function RowActionsMenu({
  ...
  return (
    <DropdownMenu>
      ...
      >
        <DropdownMenuItem onClick={onEdit} disabled={isEditDisabled} className="rounded-lg px-3 py-2.5">
        ...
        <DropdownMenuItem
          onClick={onDelete}
          className="rounded-lg px-3 py-2.5 text-destructive focus:text-destructive data-[highlighted]:bg-destructive/10 data-[highlighted]:text-destructive"
        >
