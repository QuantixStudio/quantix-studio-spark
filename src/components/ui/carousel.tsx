...
const CarouselNavigationButton = React.forwardRef<HTMLButtonElement, CarouselNavigationButtonProps>(
  ({ className, direction, variant = "ghost", size = "icon", ...props }, ref) => {
    ...
    const action = isPrevious ? scrollPrev : scrollNext;
    const isDisabled = isPrevious ? !canScrollPrev : !canScrollNext;
    const horizontalPosition = isPrevious ? "-left-12 top-1/2 -translate-y-1/2" : "-right-12 top-1/2 -translate-y-1/2";
    const verticalPosition = isPrevious ? "-top-12 left-1/2 -translate-x-1/2 rotate-90" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90";
...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>((props, ref) => {
  return <CarouselNavigationButton ref={ref} direction="previous" {...props} />;
});
CarouselPrevious.displayName = "CarouselPrevious";

const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>((props, ref) => {
  return <CarouselNavigationButton ref={ref} direction="next" {...props} />;
});
