...
- Основной hero-copy лендинга сейчас задан напрямую в `src/components/landing/Hero.tsx`.
- Текущая формулировка headline: `AI-powered Bubble platforms, SaaS apps & internal tools`.
- Текущая формулировка subtitle: `We build production-ready Bubble applications with custom backend logic, API integrations, AI workflows, dashboards, client portals, and automation systems.`
- Если CEO просит изменить главный оффер или позиционирование на первом экране, обновлять сначала этот файл, а затем при необходимости синхронизировать related sales copy в соседних landing sections.
